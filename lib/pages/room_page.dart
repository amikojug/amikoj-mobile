...
class RoomPage extends StatelessWidget {
                        ...
                        Expanded(
                          ...
                          child: Column(
                            children: <Widget>[
                              ...
                              Spacer(),
                              startOrReadyButton(context, state, _auth.getCurrentUser()),
                              Spacer(),
                              PillButton("Leave", redirect: "/home", action: () async {
  ...
  Widget startOrReadyButton(BuildContext ctx, RoomState roomState, UserModule player) {
